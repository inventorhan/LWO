...
원단위 = 110 / 333 = 0.33대
여유율 적용 = 0.33 × 1.2 = 0.40대
필요 대수 = ⌈ 0.40 ⌉ + 1 = 2대`}</Formula>
    </Section>
  </>
)
...
const WarehouseAreaContent = () => (
  <>
    ...
    <Section title="입력 절차">
      ...
      <Step n="2" title="Item별 입력">Item 탭에서 적재 Item과 적재 종류를 입력하고, 선택 기준에 맞는 UPH·작업 시간·수용수 또는 용기 개수·치수를 입력합니다.</Step>
